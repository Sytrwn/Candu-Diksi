...
function Footer() {
  return (
    <footer className="footer w-full text-white footer-center p-10 bg-gradient-to-l from-biru to-ungu ">
      <aside>
        <img
          src={myLogo}
          alt="Logo"
        ...
        <div className="grid grid-flow-col gap-4">
          ...
          >
            <img
              src={ig}
              alt="Instagram"
              className="filter-white hover:scale-110 duration-200 "
              width="24"
              height="24"
            />
          </a>
          <a href="" target="_blank" rel="noopener noreferrer">
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current hover:scale-110 duration-200"
            >
